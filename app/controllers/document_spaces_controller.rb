  ...
  def create
    ...
    respond_to do |format|
      if @document_space.save
        format.html { redirect_to @document_space, notice: 'Document space was successfully created.' }
        format.json { render :show, status: :created, location: @document_space }
      else
